...
export const journeyWeeks: JourneyWeek[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { day: 25, week: 4, title: "Before & After", teaching: "The gap between Day 1 and today is the evidence of your reset.", actionType: "journal", actionLabel: "Journal Prompt", journalPrompt: "What has changed since Day 1? How do you feel different?" },
