...
const tiers = [
  {
    ...
    features: [
      ...
      "Permission Granted Oracle (52 cards)",
      "10 Mind Meditations",
      "Workbook Pages 1-10",
      "Community Access",
      "Daily Affirmations",
  ...
  {
    name: "VIP Total Reset",
    subtitle: "Premium Experience",
    price: 111,
    description: "The ultimate transformation experience with personalized coaching and exclusive access.",
    features: [
      "Everything in Tier 2",
      "Human Design Reports",
      "Monthly Group Coaching",
      "Quarterly 1:1 Breakthrough",
      "VIP-Only Content",
